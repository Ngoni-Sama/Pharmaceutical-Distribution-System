...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center><div style="font:bold 25px 'Aleo';">Sales Receipt</div>
	  <p>Pharmaceutical Distribution System<br>
	    Your Trusted Pharmaceutical Distribution System</p>
	  
	    </p>
        <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
&nbsp&nbsp&nbsp 
 You were served by:<?php echo $_SESSION['SESS_LAST_NAME'];?>
</p>
	...
	<table border="1" cellpadding="3" cellspacing="0" style="font-family: arial; font-size: 12px;text-align:left;width : 100%;">

...
<center><strong>From : <input type="text" style="width: 223px; padding:0px" name="d1" class="tcal" value="" /> To: <input type="text" style="width: 223px; padding:0px;" name="d2" class="tcal" value="" />

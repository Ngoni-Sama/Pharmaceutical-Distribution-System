...
<head>
<title>
Pharmaceutical Distribution System: Your Trusted Pharmaceutical Distribution System
</title>
...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
            ...
            <li><a href="#"><i class="icon-group icon-2x"></i> Suppliers</a> 
			<br><br><br><br><br><br>		
			<li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#000;"><center>Pharmaceutical Distribution System</center></font>
<div id="mainmain">
...
<a href="contacts.php d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i><br> Help </a>
...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="supplier.php"><i class="icon-group icon-2x"></i> Suppliers</a>                                    </li>
			<li><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Sales Report</a>                </li>
            <li><a href="contacts.php"><i class="icon-bar-chart icon-2x"></i> Help</a>                </li>
			<br><br><br><br><br><br>		
			<li>
			 <div class="hero-unit-clock">
	...
	<!--<div class="contentheader">
			...
			<font style="font: bold 44px 'Aleo'; text-shadow: 1px 1px 25px #000; color: #FFF;"><center>Pharmaceutical Distribution System</center></font>
<div id="mainmain">
